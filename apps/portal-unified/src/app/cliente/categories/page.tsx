            ...
            {ALL_CATEGORIES.map((cat, i) => (
              ...
              >
                <article className="group h-full flex items-center gap-5 bg-white rounded-[1.75rem] p-5 v2-shadow-soft v2-press v2-float">
                  ...
                  <div className="relative w-[4.5rem] h-[4.5rem] shrink-0 rounded-[1.25rem] bg-[#FFD0B4] overflow-hidden flex items-center justify-center text-primary-deep">
                    {cat.image ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <h2 className="text-[16px] font-semibold tracking-tight text-[#111111] truncate">
                        {cat.name}
                      </h2>
                      {cat.comingSoon && (
                        <span className="shrink-0 text-[10px] font-bold uppercase tracking-[0.18em] text-[#A39E97] bg-[#FAF8F4] rounded-full px-2.5 py-1">
                          Pronto
                        </span>
                      )}
                    </div>
                    <p className="text-[12.5px] font-medium text-[#6F6B66] leading-snug mt-0.5 line-clamp-2">
                      {cat.description}
                    </p>
                  </div>

                  <span className="shrink-0 w-9 h-9 rounded-full bg-[#FAF8F4] text-[#111111] flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:text-white">
