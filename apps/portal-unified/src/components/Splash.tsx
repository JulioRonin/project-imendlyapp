...
export function Splash() {
  ...
  return (
    <div
      aria-hidden
      className={`fixed inset-0 z-[100] overflow-hidden bg-[#111111] ${phase === "out" ? "v3-exit-up" : ""}`}
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[#111111]/90 via-[#111111]/30 to-[#111111]/10" />
